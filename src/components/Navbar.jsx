        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur supports-[backdrop-filter]:bg-white/5">
          <div className="flex items-center justify-between px-4 py-3 md:px-6">
            <a href="#" className="flex items-center gap-2 text-white">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-purple-500 to-blue-500 shadow-[0_0_30px_rgba(168,85,247,0.35)]">
            ...
            <div className="hidden md:block">
              <a href="#contact" className="inline-flex items-center rounded-xl bg-gradient-to-br from-purple-600 to-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-[0_10px_30px_-10px_rgba(99,102,241,0.6)] transition-transform hover:scale-[1.02]">
                Start a project
              </a>
            </div>
